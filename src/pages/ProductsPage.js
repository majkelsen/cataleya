...
const products = [
  ...
  { id: 4, link: "whitening-peel", name: "Whitening Peel", text: "Whitening peel is a specialised solution combined with forceful composition of Arbutin Citric Acid, Lactic Acid, Kojic Acid, Salicylic Acid. Its formulated with active depigmentation, antioxidants and anti-ageing agents. It helps lightens sun damaged skin, reduces stretch marks, acne scars, blackheads, tightening and lightening Skin.", shortText: "Hyperpigmentation + whitening effect", graphicName: "productWhiteningPeel", unavailable: "true" },
]
